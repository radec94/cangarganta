...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <?php
                    if ($_GET["lang"] == "cat")
                    {
                        echo '<a  class="page-scroll" href="http://www.cangarganta.com/index.html#page-top"><img src="img/logo.png"></a>';
                    }
                    else if ($_GET["lang"] == "es")
                    {
                        echo '<a  class="page-scroll" href="http://www.cangarganta.com/index-es.html#page-top"><img src="img/logo.png"></a>';
                    }
                    else
                    {
                        echo '<a  class="page-scroll" href="http://www.cangarganta.com/index-en.html#page-top"><img src="img/logo.png"></a>';
                    }
                ?>
            </div>
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <span class="copyright">Copyright &copy; OP Solutions 2015</span>
                </div>
                <div class="col-md-6">
